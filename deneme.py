...
if __name__ == "__main__":
    ...
    video_info = sv.VideoInfo.from_video_path(video_path="data/videos/vehicles.mp4")
    ...
    frame_generator = sv.get_video_frames_generator(source_path="data/videos/vehicles.mp4")
    ...
    del size[2]
    size.reverse()
    video = cv2.VideoWriter("data/outputs/cikti_videosu.mp4", cv2_fourcc, 24, size)  # output video name, fourcc, fps, size
